...
<head>
    ...
    <style>
        ...
        .letter {
            ...
            max-width: 600px;
            border-radius: 20px;
            box-shadow: 0 0 25px rgba(255, 51, 133, 0.2);
            text-align: left;
            font-size: 17px;
            line-height: 1.8;
            opacity: 0;
